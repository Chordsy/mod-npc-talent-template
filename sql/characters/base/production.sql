...
INSERT INTO `template_npc_horde` (`playerClass`, `playerSpec`, `pos`, `itemEntry`, `enchant`, `socket1`, `socket2`, `socket3`, `bonusEnchant`, `prismaticEnchant`) VALUES
    ...
    ('Rogue', 'Subtlety', 13, 42136, 0, 0, 0, 0, 0, 0),
    ('Rogue', 'Subtlety', 14, 42082, 0, 0, 0, 0, 0, 0),
    ('Rogue', 'Subtlety', 15, 45958, 3789, 0, 0, 0, 0, 0),
    ('Rogue', 'Subtlety', 16, 45962, 3789, 0, 0, 0, 0, 0),
    ('Rogue', 'Subtlety', 17, 42451, 0, 0, 0, 0, 0, 0),
    ('Rogue', 'Combat', 0, 46125, 0, 0, 0, 0, 0, 0),
    ('Rogue', 'Combat', 1, 45517, 0, 0, 0, 0, 0, 0),
    ('Rogue', 'Combat', 2, 45245, 0, 0, 0, 0, 0, 0),
    ...
    ('Druid', 'Feral', 13, 45609, 0, 0, 0, 0, 0, 0),
    ('Druid', 'Feral', 14, 46032, 0, 0, 0, 0, 0, 0),
    ('Druid', 'Feral', 15, 45613, 3789, 0, 0, 0, 0, 0),
    ('Druid', 'Feral', 17, 39757, 0, 0, 0, 0, 0, 0),
    ('Druid', 'Ballance', 0, 45497, 0, 0, 0, 0, 0, 0),
    ('Druid', 'Ballance', 1, 45133, 0, 0, 0, 0, 0, 0),
    ('Druid', 'Ballance', 4, 46194, 0, 0, 0, 0, 0, 0),
    ...
    ('Paladin', 'Retribution', 13, 42987, 0, 0, 0, 0, 0, 0),
    ('Paladin', 'Retribution', 14, 46032, 0, 0, 0, 0, 0, 0),
    ('Paladin', 'Retribution', 15, 45516, 3789, 0, 0, 0, 0, 0),
    ('Paladin', 'Retribution', 17, 42852, 0, 0, 0, 0, 0, 0),
    ('Paladin', 'Protection', 0, 45502, 0, 0, 0, 0, 0, 0),
    ('Paladin', 'Protection', 1, 45485, 0, 0, 0, 0, 0, 0),
    ('Paladin', 'Protection', 2, 46177, 0, 0, 0, 0, 0, 0),
    ...
    ('Shaman', 'Enhancement', 12, 45609, 0, 0, 0, 0, 0, 0),
    ('Shaman', 'Enhancement', 13, 45522, 0, 0, 0, 0, 0, 0),
    ('Shaman', 'Enhancement', 15, 46017, 3789, 0, 0, 0, 0, 0),
    ('Shaman', 'Enhancement', 14, 45461, 0, 0, 0, 0, 0, 0),
    ('Shaman', 'Enhancement', 16, 46097, 3789, 0, 0, 0, 0, 0),
    ('Shaman', 'Enhancement', 17, 42608, 0, 0, 0, 0, 0, 0),
    ('Shaman', 'Restoration', 0, 46201, 0, 0, 0, 0, 0, 0),
    ('Shaman', 'Restoration', 1, 45443, 0, 0, 0, 0, 0, 0),
    ('Shaman', 'Restoration', 2, 46204, 0, 0, 0, 0, 0, 0),
    ...
    ('DeathKnight', 'Frost', 13, 42987, 0, 0, 0, 0, 0, 0),
    ('DeathKnight', 'Frost', 14, 46032, 0, 0, 0, 0, 0, 0),
    ('DeathKnight', 'Frost', 15, 46097, 3789, 0, 0, 0, 0, 0),
    ('DeathKnight', 'Frost', 16, 46097, 3789, 0, 0, 0, 0, 0),
    ('DeathKnight', 'Frost', 17, 40207, 0, 0, 0, 0, 0, 0),
    ('DeathKnight', 'Unholy', 0, 40827, 3795, 3621, 3518, 0, 2787, 0),
    ('DeathKnight', 'Unholy', 1, 42041, 0, 0, 0, 0, 0, 0),
    ('DeathKnight', 'Unholy', 2, 40868, 3852, 3518, 0, 0, 0, 0),
    ...
    ('Warrior', 'Fury', 13, 42987, 0, 0, 0, 0, 0, 0),
    ('Warrior', 'Fury', 14, 46032, 0, 0, 0, 0, 0, 0),
    ('Warrior', 'Fury', 15, 45516, 3789, 0, 0, 0, 0, 0),
    ('Warrior', 'Fury', 16, 45516, 3789, 0, 0, 0, 0, 0),
    ('Warrior', 'Fury', 17, 45296, 0, 0, 0, 0, 0, 0),
    ('Warrior', 'Arms', 0, 40826, 3795, 3625, 3525, 0, 2787, 0),
    ('Warrior', 'Arms', 1, 42042, 0, 0, 0, 0, 0, 0),
    ('Warrior', 'Arms', 2, 40866, 3793, 3550, 0, 0, 3263, 0),
